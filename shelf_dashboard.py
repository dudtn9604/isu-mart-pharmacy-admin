...
# ======================================================================
    ...
    if items_df.empty:
        ...
        tab_category, tab_subcategory, tab_product, tab_placement = st.tabs([
            "📊 카테고리 교차분석", "📊 세부 카테고리 교차분석", "🔍 상품별 교차판매", "🗺️ 배치 제안"
        ])
        ...
        with tab_subcategory:
            ...
            if sub_items.empty:
                ...
                sc_sort_choice = st.radio(
                    "정렬 기준", ["동시구매 건수", "Confidence", "Lift"],
                    horizontal=True, key="sc_sort_metric",
                )
                sc_sort_col = {
                    "동시구매 건수": "count",
